...
def test_open_order_details_popup_from_feed(driver):
...
@allure.story("Детали заказа")
@allure.title("Открытие модального окна с деталями заказа")
def test_user_orders_are_visible_in_feed(driver, authorized_user, user_order_number):
    main = MainPage(driver)
    main.open_main()
...
@allure.story("Детали заказа")
@allure.title("Открытие модального окна с деталями заказа")
def test_total_done_counter_increases_after_order(driver, authorized_user):
    main = MainPage(driver)
    main.open_main()
    main.go_to_feed()
...
@allure.story("Детали заказа")
@allure.title("Открытие модального окна с деталями заказа")
def test_today_done_counter_increases_after_order(driver, authorized_user):
    main = MainPage(driver)
    main.open_main()
    main.go_to_feed()
...
@allure.story("Детали заказа")
@allure.title("Открытие модального окна с деталями заказа")
def test_new_order_number_appears_in_progress(driver, authorized_user):
    main = MainPage(driver)
    main.open_main()
